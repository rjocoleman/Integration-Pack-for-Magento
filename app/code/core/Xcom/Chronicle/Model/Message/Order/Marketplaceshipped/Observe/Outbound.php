...
class Xcom_Chronicle_Model_Message_Order_Marketplaceshipped_Observe_Outbound extends Xcom_Xfabric_Model_Message_Request
{
    protected function _construct()
    {
        parent::_construct();
        $this->_topic = 'com.x.ordermanagement.v2/ProcessSalesChannelOrder.MarketplaceOrder/ObserveMarketplaceOrderShipped';
        $this->_schemaRecordName = 'ObserveMarketplaceOrderShipped';
